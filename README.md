...
2. Run locally in Docker:  `./run_docker.sh`
3. App runs locally at http://127.0.0.1:3000
...
4. add the environment variables `AWS_REPOSITORY_URL`, `REPOSITORY_NAME`, `DATABASE_URL` and `AWS_DEFAULT_REGION` to circleci
